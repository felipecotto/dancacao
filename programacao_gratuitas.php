...
<html class="no-js" lang="pt-br">
    ...
    <body>
        ...
        <section class="bg-gray-light clearfix" id="mostra">
            ...
            <div class="container">
                <!-- Programação 01 -->
                <div class="section-flex bg-white">
                    <div class="text-center section-bg-color-marron section-1">
                    ...
                    <div class="text-center section-4">
                            ...
                            <table class="table gratuitas">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p><strong>Jam Session de Sapateado</strong></p>
                                            
                                            <p>Coord. Yara Ramos</p>
                                            <p><strong>ARENA TMTV</strong></p>
                                        </td>
                                        <td colspan="3"></td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p><strong>GRAMADO DO TMTV</strong></p>
                                        </td>
                                        <td colspan="3"></td>
                                    </tr>
                                    <tr>
